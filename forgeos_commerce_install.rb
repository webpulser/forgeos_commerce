...
plugin 'forgeos_core', :git => '-b engines http://github.com/webpulser/forgeos_core.git', :submodule => true
plugin 'forgeos_cms', :git => '-b engines http://github.com/webpulser/forgeos_cms.git', :submodule => true
plugin 'forgeos_commerce', :git => '-b engines http://github.com/webpulser/forgeos_commerce.git', :submodule => true
