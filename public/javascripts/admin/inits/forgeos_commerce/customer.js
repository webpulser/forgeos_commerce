jQuery(document).ready(function(){
  $($("input[@name='same_as_delivery']:checked")).live('click', function() {
    if($(this).val() == 'true') {
      ...
      val_address_2 = $('#user_address_invoices_attributes_0_address_2').val();
      val_zip_code = $('#user_address_invoices_attributes_0_zip_code').val();
      val_city = $('#user_address_invoices_attributes_0_city').val();
      val_civility = $('#user_address_invoices_attributes_0_civility').val();
      ...
      $('#user_address_deliveries_attributes_0_address_2').val(val_address_2);
      ...
      civility_customer_select = $('#user_address_invoices_attributes_0_civility').siblings('.dropdown').find('.dropdown_toggle').html();
      $('#user_address_deliveries_attributes_0_civility').siblings('.dropdown').find('.dropdown_toggle').html(civility_customer_select);
