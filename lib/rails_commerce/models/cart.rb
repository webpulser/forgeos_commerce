module RailsCommerce
  ...
  #
  # ==== has_many
  # * <tt>carts_product</tt> - <i>RailsCommerce::CartsProduct</i>
  # * <tt>products</tt> - <i>RailsCommerce::Product</i>
  class Cart < ActiveRecord::Base
    set_table_name "rails_commerce_carts"

    has_many :carts_products, :class_name => 'RailsCommerce::CartsProduct', :dependent => :destroy
    has_many :products, :class_name => 'RailsCommerce::Product', :through => :carts_products
    belongs_to :user
    ...
    def add_product(product, quantity=1)
      return false if product.nil? || product.is_a?(RailsCommerce::ProductParent) || product.new_record?
    ...
    #
    # ==== Parameters
    # * <tt>:product_id</tt> - an <i>id</i> of a <i>RailsCommerce::Product</i>
    # * <tt>:quantity</tt> - the quantity (1 by default)
    ...
    #
    # Returns the product's quantity if you precise a <i>RailsCommerce::Product</i> object in parameters
    #
    # ==== Parameters
    # * <tt>:product</tt> - a <i>RailsCommerce::Product</i> object
    ...
    #
    # Returns total price of a <i>RailsCommerce::Product</i> in cart if you precise in parameters
    #
    # ==== Parameters
    ...
    # Returns all <i>RailsCommerce::ShippingMethodDetail</i> available for this cart
    def get_shipping_method_details
      shipping_method_details = []
      RailsCommerce::ShippingMethod.find(:all).each do |shipping_method|
