module RailsCommerce
  ...
  module CartController
    # Show <i>RailsCommerce::Cart</i>
    #
    # A <i>flash[:notice]</i> is create (<i>RailsCommerce::OPTIONS[:text][:your_cart_is_empty]</i>) if the <i>RailsCommerce::Cart</i> is empty.
    def index
      flash[:notice] = RailsCommerce::OPTIONS[:text][:your_cart_is_empty] if @cart.is_empty?
    end

    # Add a <i>RailsCommerce::Product</i> in <i>RailsCommerce::Cart</i>
    #
    # A <i>flash[:notice]</i> is create (<i>RailsCommerce::OPTIONS[:text][:product_added]</i>) if the <i>RailsCommerce::Product</i> is added.
    #
    # ==== Parameters
    # * <tt>:id</tt> - a <i>RailsCommerce::Product</i> object
    def add_product
      reset_order_session
    ...
    # Empty the <i>RailsCommerce::Cart</i>
    #
    ...
    # Remove a <i>RailsCommerce::Product</i> of <i>RailsCommerce::Cart</i>
    #
    # A <i>flash[:notice]</i> is create (<i>RailsCommerce::OPTIONS[:text][:product_has_been_remove]</i>) if <i>RailsCommerce::Product</i> is removed
    #
    # ==== Parameters
    # * <tt>:id</tt> - a <i>RailsCommerce::Product</i> object
    def remove_product
    ...
    # Update quantity of a <i>RailsCommerce::Product</i>
    #
    # This action can be called in XHR or GET request.
    #
    # ==== Parameters
    # * <tt>:product_id</tt> - a <i>RailsCommerce::Product</i> object
    # * <tt>:quantity</tt> - a <i>RailsCommerce::Product</i> object
    def update_quantity
      reset_order_session
  ...
  protected
    ...
    #
    # User must again valid the shipping method and his voucher if his <i>RailsCommerce::Cart</i> is updated
