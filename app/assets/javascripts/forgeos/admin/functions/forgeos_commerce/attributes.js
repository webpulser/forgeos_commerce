function add_item_on_add_click() {
  ...
  new_choice += '<span class="block-image"><img src="/assets/forgeos/admin/no-image_50x50.png" id="item_'+false_id+'_image" alt="No-image_50x50"><input type="hidden" value="" name="'+object_name+'[attribute_values_attributes]['+false_id+'][picture_ids]" id="attribute_values_attributes_'+false_id+'_picture_ids"><a id="change_picture_item_'+false_id+'" class="big-icons edit change-picture" href="#"></a></span>';
