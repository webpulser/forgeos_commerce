class CartController < ApplicationController
  ...
  # Show <i>Cart</i>
  #
  # A <i>flash[:notice]</i> is create (<i>OPTIONS[:text][:your_cart_is_empty]</i>) if the <i>Cart</i> is empty.
  def index
  ...
  #
  # A <i>flash[:notice]</i> is create (<i>OPTIONS[:text][:product_added]</i>) if the <i>Product</i> is added.
  #
  # ==== Parameters
  ...
  # Empty the <i>Cart</i>
  #
  # A <i>flash[:notice]</i> is create (<i>OPTIONS[:text][:cart_is_empty]</i>).
  def empty
    reset_order_session
    get_cart.to_empty
  ...
  #
  # A <i>flash[:notice]</i> is create (<i>OPTIONS[:text][:product_has_been_remove]</i>) if <i>Product</i> is removed
  #
  # ==== Parameters
  # * <tt>:id</tt> - a <i>Product</i> object
  def remove_product
